...
- Die acht Standard-Missionsszenarien direkt auswählen und mit Seitenverweis, Kurzbriefing, Gegnerprofilen und Kampagnenfortschritt verfolgen
...
Die Gegnerprofile der acht eingebauten Szenarien sind ohne Import verfügbar und erscheinen automatisch nach der Szenarioauswahl. Der optionale Gegnerkatalog unter **Load Enemy Catalog** bleibt davon getrennt: Er dient dazu, Gegner samt vorgeschlagenem XP-Wert bequem als Kill-Zeile zur aktiven Mission hinzuzufügen. **Add blank enemy** bleibt für eigene oder szenariospezifische Gegner verfügbar. Die vorgeschlagenen Gegner-XP ersetzen nicht die **Outcome and Experience**-Regeln des gespielten Szenarios; Name und Wert bleiben deshalb in jedem Missionsbericht manuell korrigierbar.

Beim Start einer Mission stehen die acht linearen Szenarien aus **The Missing**, **The Beacon Tower** und **Descent into Darkness** ohne zusätzlichen Import bereit. Eine Auswahl übernimmt den offiziellen Titel und die Referenz, zeigt die gedruckte Regelbuchseite sowie ein knappes Ziel-, Zeit- und Erinnerungsbriefing und markiert aktuelle beziehungsweise abgeschlossene Szenarien im Kampagnenpfad. Darunter stehen alle Gegner, die durch Aufbau, Ereignisse, Suchergebnisse, Raumkarten oder den Challenge Level vorkommen können, mit Move, Fight, Shoot, Armour, Will, Health, XP, knappen Merkmalen und Bestiary-Seite. Die Anzeige ersetzt weder Aufbau, Stückzahlen, Ereignisse, vollständige Sonderregeln noch Belohnungen im Regelbuch. **Custom / unlisted scenario** bleibt für eigene Missionen und weitere Kampagnen verfügbar.

Der **Turn Tracker** erscheint bei jedem eingebauten Szenario in Edit und Play. Große `−/+`-Tasten ändern den aktuellen Zug; der Hinweis daneben berücksichtigt automatisch Ereignisse in jeder Runde, nur in ungeraden Runden, an festen Zügen, beim Öffnen neuer Räume und gedruckte Ausnahmen. Das Erreichen oder Überschreiten eines Zuglimits wird deutlich markiert, aber nicht blockiert. Der Zugstand wird mit dem Missionsbericht gespeichert und exportiert; der Tracker erinnert nur und führt keine Ereignisse selbst aus.
